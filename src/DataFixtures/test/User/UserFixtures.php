...
namespace App\DataFixtures\test\User;
...
class UserFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($usersData as $userData) {
            ...
            $user->setAvatarUpdatedAt($faker->dateTimeBetween('now'));
    ...
    private function addUserActivation(ObjectManager $manager): void
    {
        ...
        $activationUser->setFirstname($faker->firstName());
        $activationUser->setLastname($faker->lastName());
        ...
        $activationUser->setStatus(User::STATUS['INACTIVE']);

        $activationUser->setAvatarName('avatar.png');
        $activationUser->setAvatarUpdatedAt($faker->dateTimeBetween('now'));
