...
namespace App\DataFixtures\dev\User;
...
class UserFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($usersData as $userData) {
            $user = new User();
            $user->setFirstname($userData['firstname'] ?? $faker->firstName());
            $user->setLastname($userData['lastname'] ?? $faker->lastName());
            ...
            $user->setAvatarUpdatedAt(isset($userData['avatarName']) ? $faker->dateTimeBetween('now') : null);
