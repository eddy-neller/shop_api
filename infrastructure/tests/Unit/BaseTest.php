...
abstract class BaseTest extends KernelTestCase
{
     ...
     * @param string $prefix  Préfixe du nom du fichier temporaire
     *
     * @return string Chemin du fichier temporaire créé
     */
    protected function createTempFile(string $content = 'fake content', string $prefix = 'test_'): string
    {
    ...
    /**
     * Supprimer un fichier temporaire si il existe.
     */
