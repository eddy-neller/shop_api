...
namespace App\Tests\Unit\Service\Encoder;
...
final class CustomEncoderTest extends KernelTestCase
{
     ...
     * @throws RandomException
     */
    public function testRandomStringReturnsValidString(): void
    {
        $value = CustomEncoder::randomString(16);
     ...
     * @throws RandomException
     */
    public function testRandomCodeReturnsSixDigitNumber(): void
    {
        $code = CustomEncoder::randomCode();
    ...
    public function testEncryptWithInvalidAgencyKeyTooShort(): void
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage(InfoCodes::USER['INVALID_AGENCY_KEY']);
